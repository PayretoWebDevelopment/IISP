    ...
    public function up(): void
    {
        Schema::create('timesheets', function (Blueprint $table) {
            $projectTypes = [
                ...
                ['Web Development', ['Deep Dive Session', 'Meeting', 'Debugging', 'Programming and Development']],
            ];
            ...
            foreach ($projectTypes as &$projectType) {
                $typeName = $projectType[0]; //Attendance
                $subtypes = $projectType[1]; //['Break', 'Login', 'Logout']
            ...
            echo "data type of ValidProjectTypes: " . gettype($validProjectTypes);
            //print_r($validProjectTypes);

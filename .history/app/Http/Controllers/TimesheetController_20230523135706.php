...
class TimesheetController extends Controller
{
    ...
    public function stopTracking(Request $request)
    {
        ...
        $formFields = [
            'user_id' => $user_id,
            'task_name' => $request->input('task_name'), //filter_input(INPUT_POST, 'task_name', FILTER_SANITIZE_SPECIAL_CHARS),
            'task_type' => $request->input('task_type'), //filter_input(INPUT_POST, 'task_type', FILTER_SANITIZE_SPECIAL_CHARS),
            'project_type' => $request->input('project_type'), //filter_input(INPUT_POST, 'project_type', FILTER_SANITIZE_SPECIAL_CHARS),

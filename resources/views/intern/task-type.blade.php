<x-layout module_name="Task types">
    ...
    <body>
        ...
        <!-- Main modal -->
        <div id="taskTypeModal" tabindex="-1" aria-hidden="true"
                ...
                <form method="post" action="/task-types">
                    ...
                    <div class="relative bg-white rounded-lg shadow">
                        ...
                        <div class="flex justify-end items-center p-6 space-x-2 border-t border-gray-200 rounded-b">
                            <button data-modal-hide="taskTypeModal" type="button"
                            ...
                            <tr class="bg-white border-b">
                                ...
                                @if ($user->isAdmin())
                                    <td class="px-6 py-4">
                                        ...
                                        <form action="/task-delete/{{ $choice->id }}" method="POST"

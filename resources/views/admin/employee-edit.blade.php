<x-layout>
    ...
    <form action="/admin/employee-update/{{ $employee->id }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="start_date" id="start_date" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ $employee->start_date }}">
        </div>
    ...
    <form action="/admin/employee-edit-hourly-rate/{{ $employee->id }}" method="POST" onsubmit="return validateForm()">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="hourly_rate" id="hourly_rate" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ $employee->hourly_rate }}">
        </div>
        <div class="mb-4">

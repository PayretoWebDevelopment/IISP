...
<?php $component->withAttributes(['module_name' => 'Timesheets']); ?>
            ...
            <form id="startTimerForm" method="POST" action="/intern/timesheets/start">
                ...
                <div class="mb-3">
                    ...
                    <?php $__currentLoopData = $projectTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projectType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php endif; ?>
                        <option value="<?php echo e($projectType->department); ?>: <?php echo e($projectType->name); ?>">
                            <?php echo e($projectType->name); ?></option>
                        <?php
    ...
    <div class="p-6 bg-white border border-gray-200 rounded-lg shadow">
        ...
        return $entry->start_time->format('Y-W'); // Group by year and week
            ...
            <?php
                ...
                $weekBillableTotal = 0;
            ?>
            <h2 class="text-sm font-bold italic text-gray-600"><?php echo e(date('F d, Y', strtotime($startDate))); ?> to
                <?php echo e(date('F d, Y', strtotime($endDate))); ?>
        ...
        return $entry->start_time->format('Y-m-d'); // Group by year, month, and day
                ...
                <h3 class="text-xl font-extralight mt-4"><b><?php echo e($date); ?></b></h3>
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timesheet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="bg-white text-center">
                                    <td class="px-6 py-4 border"><?php echo e($timesheet->start_time->format('Y-m-d')); ?></td>
                                    <td class="px-6 py-4 border"><?php echo e($timesheet->task_name); ?></td>
                                    <td class="px-6 py-4 border"><?php echo e($timesheet->project_type); ?></td>
                                    <td class="px-6 py-4 border"><?php echo e($timesheet->task_type); ?></td>
                                    <td class="px-6 py-4 border"><?php echo e($timesheet->start_time->format('H:i:s')); ?></td>
                                    <td class="px-6 py-4 border">
                                        <?php echo e($timesheet->end_time ? $timesheet->end_time->format('H:i:s') : ''); ?>

                                    </td>
                                    <td class="px-6 py-4 border"><?php echo e($timesheet->getDurationAttribute()); ?></td>
                                    <td class="px-6 py-4 border">
                            ...
                            <?php if($isCurrentWeek && count($entries) > 0): ?>
                                <tr class="bg-white text-center">
                                    ...
                                    ?>
                                    <td class="px-6 py-4 border"><b><?php echo e($dayTotalFormatted); ?></b></td>
                                ...
                                <tr class="bg-white text-center">
                                    ...
                                    ?>
                                    <td class="px-6 py-4 border"><b><?php echo e($billableDayTotalFormatted); ?></b></td>
                                    <td class="px-6 py-4 border"></td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
    ...
    <div class="p-6 bg-white border border-gray-200 rounded-lg shadow">
        <table class="min-w-full divide-y divide-gray-200" style="width:100%">
            ...
            <tbody>
                <tr class="bg-white text-center">
                    <td class="px-6 py-4 border"><?php echo e($startDate); ?> to <?php echo e($endDate); ?></td>
                    <?php
                    ...
                    ?>
                    <td class="px-6 py-4 border"><b><?php echo e($weekTotalFormatted); ?></b></td>
                    <td class="px-6 py-4 border"><b><?php echo e($weekBillableTotalFormatted); ?></b></td>
                </tr>
            </tbody>
        </table>
    </div>

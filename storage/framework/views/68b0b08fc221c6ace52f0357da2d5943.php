...
<?php $component->withAttributes([]); ?>
    ...
    <form action="/admin/employee-update/<?php echo e($employee->id); ?>" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="contact_number" id="contact_number" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="<?php echo e($employee->contact_number); ?>">
        </div>
        <div class="mb-4">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\IISP\resources\views/admin/employee-edit.blade.php ENDPATH**/ ?>
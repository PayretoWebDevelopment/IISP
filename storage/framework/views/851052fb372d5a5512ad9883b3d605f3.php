                        ...
                        <tbody class="text-gray-600">
                            <?php $__currentLoopData = $timesheetsByUser; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user => $timesheets): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                                        <td><input type="checkbox" name="timesheets[]" value=<?php echo e($user); ?> form="export_form"></td>
                                        <td><?php echo e($timesheetsByUser[$user]['userReference']->name); ?></td>
                                        <td><?php echo e($timesheetsByUser[$user]['userReference']->role); ?></td>
                                        <td><?php echo e($timesheetsByUser[$user]['userReference']->position); ?></td>
                                        <td><?php echo e($timesheetsByUser[$user]['userReference']->hourly_rate); ?></td>
                                        ...
                                        <td>
                                            <form method="get" action="/admin/reports/inspect/<?php echo e($user); ?>" class="mt-8">
                                                <input type="hidden" name="start_date" value="<?php echo e(app('request')->input('start_date') ?? old('start_date') ?? date('Y-m-d')); ?>">
